      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-7xl md:text-8xl font-display tracking-tighter text-brand-blood dark:text-brand-gold leading-none">
              SUR<span className="text-brand-gold dark:text-brand-blood">PRISE</span>
            </h1>
            <Sparkles className="w-12 h-12 text-amber-600" />
          </div>
