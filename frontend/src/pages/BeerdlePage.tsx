          ...
          >
            <div className="relative group">
              <input
                ...
                className="w-full px-6 py-5 text-lg rounded-2xl border-2 border-transparent bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 outline-none transition-all placeholder:text-gray-400 text-gray-900 dark:text-gray-50"
              />
